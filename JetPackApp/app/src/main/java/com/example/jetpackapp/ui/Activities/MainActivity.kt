...
import com.example.jetpackapp.ui.detail.DetailFragment
...
class MainActivity : AppCompatActivity() {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.SEND_SMS) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.SEND_SMS)) {
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Ask me") { dialogInterface: DialogInterface, i: Int ->
    ...
    private fun notifyDetailFragment(isPermissionGranted: Boolean) {
        val activeFragment = fragment.childFragmentManager.primaryNavigationFragment
        if (activeFragment is DetailFragment) {
            activeFragment.onPermissionResult(isPermissionGranted)
        }
    }
}
